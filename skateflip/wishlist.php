...
<section class="heading">
    <h3 class="wish">your wishlist</h3>
    <p class="wish2"> <a href="home.php">Home</a> / Wishlist </p>
</section>
        ...
        <?php
            ...
            if(mysqli_num_rows($select_wishlist) > 0){
                ...
                <form action="" method ="POST" class="box">
                    ...
                    <img src="uploaded.img/<?php echo $fetch_wishlist['image']; ?>" alt="" class="image">
...
<script>
   ScrollReveal({
       ...
       ScrollReveal().reveal('.wish', { delay: 200, origin: 'left' });
       ScrollReveal().reveal('.wish2', { delay: 200, origin: 'right' });
