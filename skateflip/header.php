...
<header class="header">
    ...
    <div class="flex">
        ...
        <a href="home.php" class="logo"><span><div id="admin_page.php" class="fas fa-snowboarding "></div> 🆂🅺🅰🆃🅴 🅵🅻🅸🅿 </span></a>

        <nav class="navbar">
            <ul>
                    <li><a href="home.php">Home</a></li>
                    <li><a href="#">Pages <div class="fa fa-plus-square"></div></a>
                        <ul>
                    ...
                    <li><a href="#">Account <div class="fa fa-plus-square"></div></a>
                        <ul>
